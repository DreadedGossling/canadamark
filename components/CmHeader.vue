  ...
  <nav id="navigation" class="bg-cm-black sticky top-0 z-40 font-body transition-all duration-500">
    ...
    <div class="flex mx-2 items-center justify-between py-2 md:p-4">
      ...
      <div class="flex justify-end">
        <input v-model="searchQuery" class="search-box bg-transparent font-ddin shadow appearance-none border border-white py-2 px-1 md:px-3 text-white leading-tight focus:outline-none focus:shadow-outline rounded-none" type="text" placeholder="Search Your Diamond/Jewellery" @change="performSearch" >
